/**
 * Biblioteca Arduino para modulo NFC.
 * 
 ...
 * Library to use Arduino NFC module.
...
#ifndef NFC_SPICLOCK
#define NFC_SPICLOCK SPI_CLOCK_DIV4			// NFC accept upto 10MHz
#endif
...
const byte NFC_firmware_referenceV0_0[] PROGMEM = {
...
const byte NFC_firmware_referenceV1_0[] PROGMEM = {
...
// Version 2.0 (0x92)
// NXP Semiconductors; Rev. 3.8 - 17 September 2014; 16.1.1 self-test
const byte NFC_firmware_referenceV2_0[] PROGMEM = {
...
public:
	...
	// NFC registers. Described in chapter 9 of the datasheet.
	...
	// NFC commands. Described in chapter 10 of the datasheet.
	enum PCD_Command : byte {
		...
		PCD_SoftReset			= 0x0F		// resets the NFC
	};
	
	// NFC RxGain[2:0] masks, defines the receiver's signal voltage gain factor (on the PCD).
	// Described in 9.3.3.6 / table 98 of the datasheet at http://www.nxp.com/documents/data_sheet/NFC.pdf
	...
	// Member variables
	Uid uid;								// Used by LerCodigoCartao().
	
	/////////////////////////////////////////////////////////////////////////////////////
	// Functions for setting up the Arduino
	/////////////////////////////////////////////////////////////////////////////////////
	NFC();
	NFC(byte resetPowerDownPin);
	NFC(byte chipSelectPin, byte resetPowerDownPin);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	void iniciar();
	void iniciar(byte resetPowerDownPin);
	void iniciar(byte chipSelectPin, byte resetPowerDownPin);
	void PCD_Reset();
	void PCD_AntennaOn();
	void PCD_AntennaOff();
...
protected:
	...
	byte _resetPowerDownPin;	// Arduino pin connected to NFC's reset and power down input (Pin 6, NRSTPD, active low)
